      ...
      <div className="container">
        ...
        <div className="-mx-4 flex flex-wrap">
          <div className="w-full px-4 md:w-1/2 lg:w-1/4">
            ...
            className="animate__animated wow animate__fadeInUp group mb-12 bg-white" data-wow-delay=".25s">
              <div
          ...
          <div className="w-full px-4 md:w-1/2 lg:w-1/4">
            <div className="animate__animated wow animate__fadeInUp group mb-12 bg-white" data-wow-delay=".25s">
              <div
                className="relative z-10 mb-8 flex h-[70px] w-[70px] items-center justify-center rounded-2xl bg-primary"
              >
                <span
